...
// Get customer info
$stmt = $pdo->prepare("SELECT * FROM customers WHERE email = (SELECT email FROM users WHERE id = ?)");
$stmt->execute([$userId]);
    ...
    <div class="checkout-container">
        ...
        <form method="POST" id="checkoutForm">
            <div class="row">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" name="email" 
                                       value="<?= $customer['email'] ?? $_SESSION['email'] ?? '' ?>" required>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="checkout-step" style="position: sticky; top: 120px;">
                        <h3 class="mb-4" style="color: var(--black-olive);">
